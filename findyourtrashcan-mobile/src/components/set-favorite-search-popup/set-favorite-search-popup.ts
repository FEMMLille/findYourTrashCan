...
/**
 * Generated class for the SetFavoriteSearchPopupComponent component.
 *
 * See https://angular.io/api/core/Component for more info on Angular
 * Components.
 */
@Component({
  selector: 'set-favorite-search-popup',
  templateUrl: 'set-favorite-search-popup.html'
})
export class SetFavoriteSearchPopupComponent {
  ...
  showSetFavoriteSearchPopup: boolean = true;
  ...
  setFavoriteSearch(trashcan: Trashcan) {
    if (!this.disconnected) {
      this.geolocation.getCurrentPosition().then((position) => {
        ...
        this.trashcanService.setFavoritSearch(this.addedTrashcan).subscribe((res) => {
  ...
  ngOnChanges(changes: SimpleChanges) {
    ...
    if (changes['show']) {
      this.showSetFavoriteSearchPopup = !this.showSetFavoriteSearchPopup;
    }
  }
