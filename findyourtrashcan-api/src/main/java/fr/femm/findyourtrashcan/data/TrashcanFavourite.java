...
@Entity
public class TrashcanFavourite {
	...
	public TrashcanFavourite() {

	}


	public TrashcanFavourite(Integer id, TrashcanType trashcanType, GarbageType garbageType, boolean isEmpty, boolean isTrustworthy, 
	...
	public String toString() {
		return "[ TrashcanFavourite" + getId()
	    	+ "\n" + getTrashcanType()
	    	+ "\n" + getGarbageType()
	    	+ "\nisEmpty : " + isEmpty()
